...
def upgrade() -> None:
    ...
    op.alter_column('stock_adjustments', 'adjustment_type',
               existing_type=postgresql.ENUM('eigenentnahme', 'geschenk', 'verderb', 'bruch', 'inventur_plus', 'inventur_minus', 'korrektur', 'sonstiges', name='adjustment_type_enum'),
               type_=sa.Enum('eigenentnahme', 'geschenk', 'verderb', 'bruch', 'inventur_plus', 'inventur_minus', 'korrektur', 'sonstiges', name='adjustment_type_enum', native_enum=False),
    ...
    op.alter_column('users', 'reseller_type',
               existing_type=postgresql.ENUM('none', 'type1_ust_extern', 'type2_non_ust_extern', 'type3_non_ust_pwa', 'type4_owner_market', name='reseller_type_enum'),
               type_=sa.Enum('none', 'type1_ust_extern', 'type2_non_ust_extern', 'type3_non_ust_pwa', 'type4_owner_market', name='reseller_type_enum', native_enum=False),
               existing_nullable=False,
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column('users', 'reseller_type',
               existing_type=sa.Enum('none', 'type1_ust_extern', 'type2_non_ust_extern', 'type3_non_ust_pwa', 'type4_owner_market', name='reseller_type_enum', native_enum=False),
               type_=postgresql.ENUM('none', 'type1_ust_extern', 'type2_non_ust_extern', 'type3_non_ust_pwa', 'type4_owner_market', name='reseller_type_enum'),
               existing_nullable=False,
               existing_server_default=sa.text("'none'::reseller_type_enum"))
    op.drop_constraint(None, 'stock_adjustments', type_='foreignkey')
    op.drop_constraint(None, 'stock_adjustments', type_='foreignkey')
    op.create_foreign_key('stock_adjustments_product_id_fkey', 'stock_adjustments', 'products', ['product_id'], ['id'], ondelete='RESTRICT')
    ...
    op.alter_column('stock_adjustments', 'adjustment_type',
               existing_type=sa.Enum('eigenentnahme', 'geschenk', 'verderb', 'bruch', 'inventur_plus', 'inventur_minus', 'korrektur', 'sonstiges', name='adjustment_type_enum', native_enum=False),
               type_=postgresql.ENUM('eigenentnahme', 'geschenk', 'verderb', 'bruch', 'inventur_plus', 'inventur_minus', 'korrektur', 'sonstiges', name='adjustment_type_enum'),
               existing_nullable=False)
    ...
    op.create_foreign_key('invoice_status_log_invoice_id_fkey', 'invoice_status_log', 'invoices', ['invoice_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key('invoice_pdf_archive_invoice_id_fkey', 'invoice_pdf_archive', 'invoices', ['invoice_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_unique_constraint('delivery_notes_delivery_note_number_key', 'delivery_notes', ['delivery_note_number'], postgresql_nulls_not_distinct=False)
