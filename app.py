...
{app.config.get('COMPANY_NAME', '')}"""
    ...
    def annual_revenue_report():
        ...
        for month in range(1, 13):
            stats["by_month"][month] = {"revenue": Decimal("0.00"), "count": 0, "label": month_names[month - 1]}
    ...
    def annual_revenue_report_pdf():
        ...
        # Alle bezahlten Rechnungen des Jahres
        invoices = Invoice.query.filter(extract("year", Invoice.invoice_date) == year, Invoice.status == "paid").all()
