...
from models import db, Customer, Invoice, LineItem, Product, DeliveryNote, DeliveryNoteItem, ConsignmentStock, PaymentCheck, Reminder, InvoiceStatusLog, InvoicePdfArchive
...
def cleanup_database():
    ...
    with app.app_context():
        try:
            ...
            tables = [
                'invoices', 'line_items', 'products', 'delivery_notes', 
                'delivery_note_items', 'consignment_stock', 'payment_checks', 
                'reminders', 'invoice_status_log', 'invoice_pdf_archive'
            ]
