...
def generate_reminder_pdf(invoice, reminder, pdf_folder, config=None):
    ...
    # Anrede und Mahntext
    salutation = "Sehr geehrte Damen und Herren," if not invoice.customer.first_name else f"Sehr geehrte/r {invoice.customer.first_name} {invoice.customer.last_name},"
